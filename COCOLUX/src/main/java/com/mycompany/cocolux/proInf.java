 ...
 * @author ASUS
 */
public class proInf extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proInf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
